...
var hljs = function () {
  ...
  var g = "(-?)(\\b0[xX][a-fA-F0-9]+|(\\b\\d+(\\.\\d*)?|\\.\\d+)([eE][-+]?\\d+)?)",
      h = {
    begin: "\\\\[\\s\\S]",
    relevance: 0
  },
  ...
  return function (t) {
    ...
    function m(e, t, a, s) {
      ...
      function u() {
        null != y.subLanguage ? function () {
          ...
          var n = y.keywordPatternRe.exec(A),
              t = "";
      ...
      function x(t, r) {
        ...
        if ("begin" === b.type && "end" === r.type && b.index === r.index && "" === i) {
          if (A += o.slice(r.index, r.index + 1), !l) {
            ...
            throw _n3.languageName = e, _n3.badRule = b.rule, _n3;
          }
        ...
        if ("illegal" === r.type && !a) {
          var _e2 = Error('Illegal lexeme "' + i + '" for mode "' + (y.className || "<unnamed>") + '"');

          throw _e2.mode = y, _e2;
        }
      ...
      var _ = function (e) {
        ...
        return function t(s, o) {
          ...
          return l.keywordPatternRe = n(s.lexemes || c || /\w+/, !0), o && (s.beginKeywords && (s.begin = "\\b(" + s.beginKeywords.split(" ").join("|") + ")(?=\\b|\\s)", s.__beforeBegin = i), s.begin || (s.begin = /\B|\b/), l.beginRe = n(s.begin), s.endSameAsBegin && (s.end = s.begin), s.end || s.endsWithParent || (s.end = /\B|\b/), s.end && (l.endRe = n(s.end)), l.terminator_end = d(s.end) || "", s.endsWithParent && o.terminator_end && (l.terminator_end += (s.end ? "|" : "") + o.terminator_end)), s.illegal && (l.illegalRe = n(s.illegal)), void 0 === s.relevance && (s.relevance = 1), s.contains || (s.contains = []), s.contains = (_ref3 = []).concat.apply(_ref3, _toConsumableArray(s.contains.map(function (e) {
            return function (e) {
      ...
      try {
        for (y.matcher.considerAll();;) {
          ...
          var _e4 = y.matcher.exec(o);

          if (!_e4) break;

          var _n5 = x(o.substring(S, _e4.index), _e4);
    ...
    function E(e) {
      ...
      if (i.length) {
        ...
        _e5.innerHTML = a.value, a.value = O(i, k(_e5), r);
      }
...
module.exports = __webpack_require__(/*! /Users/macdonalds/laravel/study_strage/resources/js/highlight.pack.js */"./resources/js/highlight.pack.js");
